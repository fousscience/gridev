...
export default async function ContactPage() {
  ...
  return (
    <>
      <PageBanner
        title="Contact"
        description="Une question, une proposition, un partenariat ? Écrivez-nous."
      />
      <div className="section">
        <div className="container grid gap-12 md:grid-cols-2">
          ...
          <Reveal delay={0.12} variant="left">
            <div className="card-hover rounded-3xl border border-[var(--line)] bg-[var(--surface-elevated)]/80 p-6 md:p-8">
              <ContactForm />
            </div>
          </Reveal>
        </div>
